...
class TestCryptoObject(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.ecc_public_key_file_path = self.test_data_path + '/ecc/client_public.pem'
        self.ecc_private_key_file_path = self.test_data_path + '/ecc/server_private.pem'
    pass
    ...
    def test_load_ecc_private_key(self):
        self.crypto_object.load_server_ecc_private_key(pem_file_path=self.ecc_private_key_file_path, password=b'123456')
    ...
    def test_generate_ecdh_aes256_key(self):
        ...
        self.assertEqual(shared_secret.hex().upper(), '9241E08C0C8B7620BB62FE6A91610E8BB013FB6B3D946CE3B8170B871625D033')
        pass
