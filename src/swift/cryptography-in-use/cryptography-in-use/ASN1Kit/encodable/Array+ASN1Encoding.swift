...
extension Array where Element == ASN1EncodableType {
    /// ASN.1 encoding of a array using the given tag (optional)
    ///
    /// - Parameter tag: the encapsulating tag (default: .universal(.set))
